...
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    VALUES ('1', '机构管理', 'base/branch/list.html', NULL, '1', 'fa fa-circle-o');
set @parentId = @@identity;
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '刷新', '/sys/branch/list', 'sys:branch:list', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '新增', '/sys/branch/save', 'sys:branch:save', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '修改', '/sys/branch/update', 'sys:branch:edit', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '删除', '/sys/branch/remove', 'sys:branch:remove', '2', 'fa fa-circle-o';  
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    VALUES ('1', '商户管理', 'base/restaurant/list.html', NULL, '1', 'fa fa-circle-o');
set @parentId = @@identity;
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '刷新', '/sys/restaurant/list', 'sys:restaurant:list', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '新增', '/sys/restaurant/save', 'sys:restaurant:save', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '修改', '/sys/restaurant/update', 'sys:restaurant:edit', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    SELECT @parentId, '删除', '/sys/restaurant/remove', 'sys:restaurant:remove', '2', 'fa fa-circle-o';
INSERT INTO `sys_menu` (`parent_id`, `name`, `url`, `perms`, `type`, `icon`)
    VALUES ('1', '电子面单', '/kuaidi', NULL, '1', 'fa fa-circle-o');
-- ----------------------------
...
INSERT INTO `sys_role_menu` VALUES (null, '1', '65');
INSERT INTO `sys_role_menu` VALUES (null, '1', '66');
INSERT INTO `sys_role_menu` VALUES (null, '1', '67');
INSERT INTO `sys_role_menu` VALUES (null, '1', '68');
INSERT INTO `sys_role_menu` VALUES (null, '1', '69');
INSERT INTO `sys_role_menu` VALUES (null, '1', '70');
INSERT INTO `sys_role_menu` VALUES (null, '1', '71');
INSERT INTO `sys_role_menu` VALUES (null, '1', '72');
INSERT INTO `sys_role_menu` VALUES (null, '1', '73');
INSERT INTO `sys_role_menu` VALUES (null, '1', '74');
INSERT INTO `sys_role_menu` VALUES (null, '1', '75');
-- ----------------------------
...
DROP TABLE IF EXISTS sys_restaurant;
create table sys_restaurant
(
	ID		char(10) NOT NULL PRIMARY KEY COMMENT '编号',
	NAME		char(20) COMMENT '名称',
	DEPT		char(10) NOT NULL COMMENT '所属辖区代码',
	ADDR	char(100) COMMENT '地址',
	TEL		char(20) COMMENT '电话',
	MOBILE	char(15) COMMENT '手机',
	STATE	char(1) COMMENT '是否安装监控,0:未安装,1:已安装',
	INSTDATE	char(12) COMMENT '安装时间',
	PAD1		char(10),
	PAD2		char(64)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商户管理';
...
(
	ID	char(22) NOT NULL PRIMARY KEY COMMENT '系统单号',
	LOGISTICSID	char(20) COMMENT '快递单号',
	DEPT	char(10) NOT NULL COMMENT '寄件机构编号',
	SENDERNAME	char(25) NOT NULL COMMENT '发件人姓名',
	SENDERPHONE	char(20) COMMENT '发件人固定电话',
	SENDERMOBILE	char(11) NOT NULL COMMENT '发件人手机号',
	SENDERPROVINCE	char(10) NOT NULL COMMENT '发件人地址省份',
	SENDERCITY	char(20) NOT NULL COMMENT '发件人地址市',
	SENDERDISTRICT	char(20) NOT NULL COMMENT '发件人地址区',
	SENDERDETAIL	char(40) NOT NULL COMMENT '发件人详细地址',
	RECEIVERNAME	char(25) NOT NULL COMMENT '收件人姓名',
	RECEIVERMOBILE	char(11) NOT NULL COMMENT '收件人手机号',
	RECEIVERPROVINCE	char(10) NOT NULL COMMENT '收件人地址省份',
	RECEIVERCITY	char(20) NOT NULL COMMENT '收件人地址市',
	RECEIVERDISTRICT	char(20) NOT NULL COMMENT '收件人地址区',
	RECEIVERDETAIL	char(40) NOT NULL COMMENT '收件人详细地址',
	REMARK	char(20) COMMENT '备注',
	GOODSTYPE1	char(6) COMMENT '商品种类大类',
	GOODSTYPE2	char(6) COMMENT '商品种类小类',
	GOODSOTHER	char(20) COMMENT '其他种类备注',
	WEIGHT	double precision COMMENT '重量',
	COST	double precision COMMENT '费用',
	STATE	char(1) COMMENT '状态',
	DATE1	char(8) COMMENT '1级入库日期',
	TIME1	char(6) COMMENT '1级出库时间',
	DATE2	char(8) COMMENT '2级入库日期',
	TIME2	char(6) COMMENT '2级出库时间',
	DATE3	char(8) COMMENT '3级入库日期',
	TIME3	char(6) COMMENT '3级出库时间',
	PAD1	char(10),
	PAD2	char(64)
...
(
	ID		char(10) not null primary key comment '编号', 
	NAME		char(20) comment '名称', 
	DEPT		char(8) comment '上级区域编号', 
	DEPTID	char(40) comment '综合编号', 
	LEVEL		char(1) comment '层级1:街道,2:区县,3:地市', 
	ADDR		char(40) comment '地址', 
	TEL		char(20) comment '电话', 
	PAD1		char(10)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='地区信息';
INSERT INTO sys_branch VALUES ('0001','兰州市','0000','0000','3','','','');
INSERT INTO sys_branch VALUES ('1001','城关区','0001','0000,1001','2','','','');