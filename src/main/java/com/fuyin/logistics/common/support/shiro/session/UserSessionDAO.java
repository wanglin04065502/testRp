package com.fuyin.logistics.common.support.shiro.session;

import com.fuyin.logistics.common.support.redis.RedisCacheManager;
import com.fuyin.logistics.common.utils.SpringContextUtils;
...
public class UserSessionDAO extends EnterpriseCacheSessionDAO {
    ...
    private static final String SHIRO_SESSION_ID = "session:id:";
